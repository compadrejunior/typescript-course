...
> A function that returns `void` will return. `undefined` when compiled to JavaScript. `undefined` cannot be assigned as a return type of a function. (TypeScript < 5.0.0). `undefined` is an accepted type to be assigned to a variable.
...
[[<< Previous]](../Chapter-01/README.md) [[^Top]](#chapter-2-typescript-basics--basic-types) [[Next >>]](../Chapter-03/README.md)
